...
const absences = [
  { date: "2026-09-17", kind: "paid_leave" as const },
  { date: "2026-09-18", kind: "substitution" as const },
];
// 사흘 근무 + 유급 휴가 하루 + 대타로 쉰 하루 → 개근, 휴가수당 줄이 생긴다
const shifts = shiftsOn([14, 15, 16], 10, 14);

export default function PayViewLeave() {
  return <PayView shifts={shifts} settings={settings} year={2026} month={8} now={now} absences={absences} />;
}
